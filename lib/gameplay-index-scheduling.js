...
/**
 * Fast mode is deliberately bounded so short sessions gain parallelism without
 * turning long recordings into hundreds of API calls.
 *
 * @param {number} combinedDurationMs
 * @param {boolean} fastModeEnabled
...
export function selectGameplaySegmentationMode(
  ...
  return fastModeEnabled && combinedDurationMs <= maximumFastDurationMs ? "fast" : "normal";
}
